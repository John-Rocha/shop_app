...
import 'package:shop_app/data/app_preferences.dart';
...
class AuthProvider with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    if (body['error'] != null) {
      ...
      AppPreferences.saveMap('userData', {
        'token': _token,
        'email': _email,
        'userId': _userId,
  ...
  Future<void> tryAutoLogin() async {
    ...
    final userData = await AppPreferences.getMap('userData');
  ...
  void logout() {
    ...
    _expiryDate = null;
    _clearLogoutTimer();
    AppPreferences.remove('userData').then((_) {
      notifyListeners();
    });
  }
